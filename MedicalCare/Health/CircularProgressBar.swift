...
class CircularProgressBar: UIView {
    ...
    private func drawBackgroundLayer(){
        ...
        self.backgroundLayer.strokeColor = UIColor.clear.cgColor //UIColor.lightGray.cgColor
    ...
    private func drawForegroundLayer(){
        ...
        foregroundLayer.strokeColor = clGreenGardient.cgColor
    ...
    private func setForegroundLayerColorForSafePercent(){
        if Int(label.text!)! >= self.safePercent {
            self.foregroundLayer.strokeColor = clGreenGardient.cgColor
        } else {
